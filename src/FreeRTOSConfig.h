...
#define configTOTAL_HEAP_SIZE                   (8 * 1024) // Adjustable - TM4C123 should support at least 24KB heap, was originally: 10240
#define configAPPLICATION_ALLOCATED_HEAP        0 // linker script allocates heap memory
...
#define configMAX_SYSCALL_INTERRUPT_PRIORITY    (5 << 5) // according to tivaware freertos example
